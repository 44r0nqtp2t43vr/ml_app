                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          AppBodyText(text: "進給量=${_currentRC.feedRate != null ? _currentRC.feedRate!.toStringAsFixed(3) : "NULL"}"),
                          AppBodyText(text: "主軸轉速(粗)=${_currentRC.spindleSpeedRough != null ? _currentRC.spindleSpeedRough!.toStringAsFixed(3) : "NULL"}"),
                          AppBodyText(text: "主軸轉速(精)=${_currentRC.spindleSpeedFine != null ? _currentRC.spindleSpeedFine!.toStringAsFixed(3) : "NULL"}"),
                          AppBodyText(text: "主軸電流=${_currentRC.spindleCurrent != null ? _currentRC.spindleCurrent!.toStringAsFixed(3) : "NULL"}"),
                          const SizedBox(height: 20),
                          const AppTitleText(title: "AI預測結果"),
                          AppBodyText(text: "進給量=${_modelOutput.feedRate!.toStringAsFixed(3)}"),
                          AppBodyText(text: "主軸轉速(粗)=${_modelOutput.spindleSpeedRough != null ? _modelOutput.spindleSpeedRough!.toStringAsFixed(3) : "NULL"}"),
                          AppBodyText(text: "主軸轉速(精)=${_modelOutput.spindleSpeedFine != null ? _modelOutput.spindleSpeedFine!.toStringAsFixed(3) : "NULL"}"),
